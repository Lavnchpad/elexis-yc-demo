...
export const orgFit = {
  ...
  matchPercent: 72,
  industries: [
    { name: "Enterprise SaaS", years: 4, relevance: "High", detail: "Large-scale apps at Infosys, multi-tenant architecture" },
    { name: "FinTech", years: 2, relevance: "Medium", detail: "Consumer lending app, payment gateways, KYC at ZestMoney" },
    { name: "Automotive", years: 0.5, relevance: "Low", detail: "Dealership analytics platform at Tekion Corp (intern)" },
  ],
};
...
export const demoShortlistedCandidates = [
  ...
  // ── Backend Engineer — AccountingBaba candidates ──
  {
    ...
    rubricMatch: {
      mustHave: [
        ...
        { skill: "PostgreSQL", resumeSections: ["Skills", "Experience"], github: { status: "moderate", repos: 4, commits: 85, latest: "2 weeks ago", detail: "Schema design and query optimization." }, interview: { status: "confirmed", note: "Solid understanding of indexing and query plans." }, confidence: "high", rubricWeight: 10, score: 8 },
        { skill: "REST APIs", resumeSections: ["Skills", "Experience"], github: { status: "strong", repos: 6, commits: null, latest: null, detail: "Well-structured APIs with proper error handling." }, interview: { status: "confirmed", note: "Articulated API versioning and pagination strategies." }, confidence: "high", rubricWeight: 10, score: 9 },
      ],
      shouldHave: [
        { skill: "Docker / K8s", resumeSections: ["Skills"], github: { status: "moderate", repos: 3, commits: 40, latest: "1 month ago", detail: "Docker Compose for local dev, basic K8s manifests." }, interview: { status: "confirmed", note: "Uses Docker daily, basic K8s understanding." }, confidence: "medium", rubricWeight: 10, score: 8 },
        { skill: "Message Queues", resumeSections: ["Experience"], github: { status: "moderate", repos: 2, commits: 30, latest: null, detail: "Kafka consumer in order processing service." }, interview: { status: "confirmed", note: "Explained Kafka partitioning and consumer group rebalancing." }, confidence: "high", rubricWeight: 10, score: 8 },
      ],
      niceToHave: [
        { skill: "GraphQL", resumeSections: [], github: { status: "none", repos: 0, commits: 0, latest: null, detail: "No GraphQL code found." }, interview: null, confidence: "low", rubricWeight: 10, score: 0 },
        { skill: "Redis", resumeSections: ["Skills"], github: { status: "moderate", repos: 2, commits: null, latest: null, detail: "Caching layer in e-commerce APIs." }, interview: { status: "confirmed", note: "Good caching strategy understanding." }, confidence: "medium", rubricWeight: 10, score: 8 },
      ],
    },
    githubDiscoveries: [
  ...
  },
  {
    ...
    rubricMatch: {
      mustHave: [
        ...
        { skill: "PostgreSQL", resumeSections: ["Skills", "Experience"], github: { status: "strong", repos: 6, commits: 220, latest: "4 days ago", detail: "Complex migrations, partitioning, and query optimization." }, interview: null, confidence: "high", rubricWeight: 10, score: 9 },
        { skill: "REST APIs", resumeSections: ["Skills", "Experience"], github: { status: "strong", repos: 7, commits: null, latest: null, detail: "OpenAPI specs and API gateway patterns." }, interview: null, confidence: "high", rubricWeight: 10, score: 8 },
      ],
      shouldHave: [
        { skill: "Docker / K8s", resumeSections: ["Skills"], github: { status: "strong", repos: 4, commits: 90, latest: "1 week ago", detail: "Helm charts and K8s deployment configs." }, interview: null, confidence: "high", rubricWeight: 10, score: 9 },
        { skill: "Message Queues", resumeSections: [], github: { status: "none", repos: 0, commits: 0, latest: null, detail: "No message queue code found." }, interview: null, confidence: "low", rubricWeight: 10, score: 0 },
      ],
      niceToHave: [
        { skill: "GraphQL", resumeSections: ["Skills"], github: { status: "moderate", repos: 2, commits: null, latest: null, detail: "Apollo Server in side projects." }, interview: null, confidence: "medium", rubricWeight: 10, score: 7 },
        { skill: "Redis", resumeSections: ["Skills", "Experience"], github: { status: "strong", repos: 5, commits: null, latest: null, detail: "Redis pub/sub and caching in payment services." }, interview: null, confidence: "high", rubricWeight: 10, score: 8 },
      ],
    },
    githubDiscoveries: [
  ...
  // ── React Native Developer — Sahas Engineering Corp. candidates ──
  {
    ...
    rubricMatch: {
      mustHave: [
        ...
        { skill: "TypeScript", resumeSections: ["Skills", "Experience"], github: { status: "strong", repos: 15, commits: 600, latest: "1 day ago", detail: "Strict TS across all projects with generics and utility types." }, interview: { status: "confirmed", note: "Excellent TypeScript fluency." }, confidence: "high", rubricWeight: 10, score: 9 },
        { skill: "State Management", resumeSections: ["Skills"], github: { status: "moderate", repos: 6, commits: null, latest: null, detail: "Redux Toolkit and Zustand in various projects." }, interview: { status: "confirmed", note: "Articulated trade-offs between Redux and Zustand." }, confidence: "high", rubricWeight: 10, score: 8 },
      ],
      shouldHave: [
        { skill: "Native Modules", resumeSections: ["Experience"], github: { status: "strong", repos: 3, commits: 85, latest: "2 weeks ago", detail: "Custom camera and BLE bridging modules." }, interview: { status: "confirmed", note: "Has written native Swift and Kotlin bridge code." }, confidence: "high", rubricWeight: 10, score: 9 },
        { skill: "CI/CD Mobile", resumeSections: ["Skills"], github: { status: "moderate", repos: 2, commits: null, latest: null, detail: "Fastlane configs for iOS and Android." }, interview: { status: "confirmed", note: "Uses Fastlane + GitHub Actions for builds." }, confidence: "medium", rubricWeight: 10, score: 7 },
      ],
      niceToHave: [
        { skill: "Animations", resumeSections: ["Skills"], github: { status: "strong", repos: 4, commits: null, latest: null, detail: "Reanimated 3 with gesture-based interactions." }, interview: { status: "confirmed", note: "Impressive Reanimated knowledge." }, confidence: "high", rubricWeight: 10, score: 9 },
        { skill: "Testing", resumeSections: ["Skills"], github: { status: "moderate", repos: 8, commits: null, latest: null, detail: "Jest + React Native Testing Library with 70%+ coverage." }, interview: null, confidence: "medium", rubricWeight: 10, score: 8 },
      ],
    },
    githubDiscoveries: [
  ...
  },
  {
    ...
    rubricMatch: {
      mustHave: [
        ...
        { skill: "TypeScript", resumeSections: ["Skills", "Experience"], github: { status: "strong", repos: 20, commits: 800, latest: "today", detail: "TS across React web and RN projects." }, interview: null, confidence: "high", rubricWeight: 10, score: 9 },
        { skill: "State Management", resumeSections: ["Skills", "Experience"], github: { status: "strong", repos: 10, commits: null, latest: null, detail: "Redux, Zustand, and Jotai in production React apps." }, interview: null, confidence: "high", rubricWeight: 10, score: 8 },
      ],
      shouldHave: [
        { skill: "Native Modules", resumeSections: [], github: { status: "none", repos: 0, commits: 0, latest: null, detail: "No native module code found." }, interview: null, confidence: "low", rubricWeight: 10, score: 0 },
        { skill: "CI/CD Mobile", resumeSections: [], github: { status: "none", repos: 0, commits: 0, latest: null, detail: "No mobile CI/CD configs." }, interview: null, confidence: "low", rubricWeight: 10, score: 0 },
      ],
      niceToHave: [
        { skill: "Animations", resumeSections: ["Skills"], github: { status: "strong", repos: 6, commits: null, latest: null, detail: "Framer Motion expert — transferable to Reanimated." }, interview: null, confidence: "medium", rubricWeight: 10, score: 7 },
        { skill: "Testing", resumeSections: ["Skills", "Experience"], github: { status: "strong", repos: 12, commits: null, latest: null, detail: "Jest, RTL, Cypress in React web projects." }, interview: null, confidence: "high", rubricWeight: 10, score: 8 },
      ],
    },
    githubDiscoveries: [
  ...
  // ── DevOps Engineer — Soltech Techservices candidates ──
  {
    id: "sc-siddharth",
    name: "Siddharth Nair",
    initials: "SN",
    ...
    jobClient: "Soltech Techservices",
    roleFitScore: 84,
    growthPotential: 78,
    interviewStatus: "completed",
    interviewDate: "2026-01-28T10:00:00Z",
    interviewScores: [
      { area: "Technical Depth", score: 9, max: 10 },
      { area: "System Design", score: 8, max: 10 },
      { area: "Communication", score: 7, max: 10 },
    ...
    interviewKeyFindings: [
      "Strong Kubernetes experience — manages 20+ microservices on AWS EKS with Helm charts and Kustomize. Has handled zero-downtime deployments for 3 production clusters.",
      "Solid CI/CD skills — designed Jenkins and GitHub Actions pipelines with automated testing gates, security scanning (Trivy, SonarQube), and blue-green deployments.",
      "Terraform expert — built IaC for multi-account AWS setups with module composition and state locking. Manages 50+ resources per environment.",
      "Monitoring is strong — uses Prometheus + Grafana stack with custom alerting rules. Has reduced MTTR from 45 min to 12 min through better observability.",
      "Available in 30 days. Comfortable with on-call rotations and incident management.",
    ],
    interviewRecommendation: "STRONG FIT",
    rubricMatch: {
      mustHave: [
        { skill: "Kubernetes", resumeSections: ["Skills", "Experience"], github: { status: "strong", repos: 10, commits: 420, latest: "3 days ago", detail: "Helm charts, Kustomize, EKS configs for production clusters." }, interview: { status: "confirmed", note: "Deep K8s knowledge — resource limits, HPA, network policies." }, confidence: "high", rubricWeight: 10, score: 9 },
        { skill: "CI/CD Pipelines", resumeSections: ["Skills", "Experience"], github: { status: "strong", repos: 8, commits: 280, latest: "1 week ago", detail: "Jenkins, GitHub Actions with multi-stage builds and security scanning." }, interview: { status: "confirmed", note: "Articulated pipeline design with rollback strategies." }, confidence: "high", rubricWeight: 10, score: 9 },
        { skill: "Terraform / IaC", resumeSections: ["Skills", "Experience"], github: { status: "strong", repos: 6, commits: 340, latest: "5 days ago", detail: "Modular Terraform with remote state and workspace management." }, interview: { status: "confirmed", note: "Explained drift detection and module versioning strategy." }, confidence: "high", rubricWeight: 10, score: 9 },
      ],
      shouldHave: [
        { skill: "AWS Services", resumeSections: ["Skills", "Experience"], github: { status: "strong", repos: 7, commits: 200, latest: "1 week ago", detail: "EC2, EKS, RDS, S3, Lambda, CloudFront configs." }, interview: { status: "confirmed", note: "Solid multi-service AWS understanding with cost awareness." }, confidence: "high", rubricWeight: 10, score: 9 },
        { skill: "Monitoring / Observability", resumeSections: ["Skills", "Experience"], github: { status: "moderate", repos: 3, commits: 85, latest: "2 weeks ago", detail: "Prometheus, Grafana dashboards, AlertManager configs." }, interview: { status: "confirmed", note: "Impressive MTTR reduction story with custom alert rules." }, confidence: "high", rubricWeight: 10, score: 9 },
      ],
      niceToHave: [
        { skill: "Python / Scripting", resumeSections: ["Skills"], github: { status: "moderate", repos: 5, commits: 120, latest: "3 weeks ago", detail: "Python automation scripts for infra tasks." }, interview: { status: "confirmed", note: "Uses Python for custom tooling." }, confidence: "medium", rubricWeight: 10, score: 7 },
        { skill: "Security / Compliance", resumeSections: ["Skills"], github: { status: "moderate", repos: 2, commits: 40, latest: null, detail: "Trivy scanning configs and IAM policies." }, interview: { status: "confirmed", note: "Understands shift-left security approach." }, confidence: "medium", rubricWeight: 10, score: 8 },
      ],
    },
    githubDiscoveries: [
      { skill: "ArgoCD", detail: "GitOps deployment configs in 3 repos — relevant for continuous deployment", relevant: true },
      { skill: "Ansible", detail: "Config management playbooks for server provisioning", relevant: true },
    ],
  },
  {
    id: "sc-meera",
    name: "Meera Joshi",
    initials: "MJ",
    email: "meera.joshi.ops@gmail.com",
    phone: "+91 87654 32100",
    currentRole: "SRE / Platform Engineer",
    ...
    growthPotential: 86,
    interviewStatus: "completed",
    interviewDate: "2026-01-30T14:00:00Z",
    interviewScores: [
      { area: "Technical Depth", score: 8, max: 10 },
      { area: "System Design", score: 9, max: 10 },
      { area: "Communication", score: 9, max: 10 },
    ...
    interviewKeyFindings: [
      "Platform engineering mindset — built internal developer platforms at Thoughtworks with self-service infrastructure provisioning and golden path templates.",
      "Strong system design thinking — proposed SLO-based reliability framework with error budgets and graduated rollout policies.",
      "Excellent communicator — articulated complex distributed systems concepts clearly, bridging technical and business perspectives.",
      "GCP-heavy background — Kubernetes on GKE, Cloud Build, and Terraform. AWS experience is secondary but adequate.",
      "45 days notice — currently wrapping up a client engagement.",
    ],
    interviewRecommendation: "RECOMMENDED",
    rubricMatch: {
      mustHave: [
        { skill: "Kubernetes", resumeSections: ["Skills", "Experience"], github: { status: "strong", repos: 8, commits: 350, latest: "1 week ago", detail: "GKE clusters with Istio service mesh and custom operators." }, interview: { status: "confirmed", note: "Deep understanding of service mesh and K8s operators." }, confidence: "high", rubricWeight: 10, score: 8 },
        { skill: "CI/CD Pipelines", resumeSections: ["Skills", "Experience"], github: { status: "moderate", repos: 5, commits: 160, latest: "2 weeks ago", detail: "Cloud Build and Tekton pipelines, some GitHub Actions." }, interview: { status: "confirmed", note: "Good pipeline design but more GCP Cloud Build than Jenkins/GH Actions." }, confidence: "medium", rubricWeight: 10, score: 8 },
        { skill: "Terraform / IaC", resumeSections: ["Skills", "Experience"], github: { status: "strong", repos: 7, commits: 280, latest: "4 days ago", detail: "Terraform with Terragrunt, workspace management, and policy as code." }, interview: { status: "confirmed", note: "Uses Terragrunt and OPA for policy enforcement." }, confidence: "high", rubricWeight: 10, score: 9 },
      ],
      shouldHave: [
        { skill: "AWS Services", resumeSections: ["Skills"], github: { status: "weak", repos: 2, commits: 35, latest: "2 months ago", detail: "Basic EC2 and S3 configs — primarily a GCP engineer." }, interview: { status: "gap_confirmed", note: "Admitted AWS is secondary; would need ramp-up time." }, confidence: "low", rubricWeight: 10, score: 5 },
        { skill: "Monitoring / Observability", resumeSections: ["Skills", "Experience"], github: { status: "strong", repos: 5, commits: 140, latest: "1 week ago", detail: "Datadog, Prometheus, OpenTelemetry tracing." }, interview: { status: "confirmed", note: "Built SLO-based monitoring with error budgets." }, confidence: "high", rubricWeight: 10, score: 9 },
      ],
      niceToHave: [
        { skill: "Python / Scripting", resumeSections: ["Skills", "Experience"], github: { status: "strong", repos: 8, commits: 240, latest: "1 week ago", detail: "Python CLI tools and automation frameworks." }, interview: { status: "confirmed", note: "Strong Python scripting for platform tooling." }, confidence: "high", rubricWeight: 10, score: 9 },
        { skill: "Security / Compliance", resumeSections: ["Skills", "Experience"], github: { status: "strong", repos: 4, commits: 90, latest: "3 weeks ago", detail: "OPA policies, Vault integration, RBAC configurations." }, interview: { status: "confirmed", note: "Deep security-as-code experience." }, confidence: "high", rubricWeight: 10, score: 8 },
      ],
    },
    githubDiscoveries: [
      { skill: "Crossplane", detail: "Infrastructure composition with Crossplane — advanced cloud-native IaC", relevant: true },
    ],
  },
  {
    id: "sc-rohan",
    name: "Rohan Patil",
    initials: "RP",
    email: "rohan.patil.devops@outlook.com",
    ...
    growthPotential: 70,
    interviewStatus: "completed",
    interviewDate: "2026-02-02T11:00:00Z",
    interviewScores: [
      { area: "Technical Depth", score: 7, max: 10 },
      { area: "System Design", score: 8, max: 10 },
      { area: "Communication", score: 8, max: 10 },
      { area: "Problem Solving", score: 7, max: 10 },
      { area: "Culture Fit", score: 6, max: 10 },
    ],
    interviewKeyFindings: [
      "Management-heavy profile — leads a team of 4 DevOps engineers but has been hands-off on implementation for the past year.",
      "Strong conceptual knowledge of AWS and Terraform but recent GitHub activity is sparse — mostly documentation and PR reviews.",
      "Good system design from an architectural level — proposed multi-region DR strategy with clear RTO/RPO targets.",
      "Culture fit concern — currently in a large enterprise environment, may find the pace and ambiguity of Soltech challenging.",
      "60 days notice — longest wait time among candidates.",
    ],
    interviewRecommendation: "ON HOLD",
    rubricMatch: {
      mustHave: [
        { skill: "Kubernetes", resumeSections: ["Skills", "Experience"], github: { status: "weak", repos: 3, commits: 45, latest: "2 months ago", detail: "Basic K8s manifests and Helm charts — mostly review comments." }, interview: { status: "gap_confirmed", note: "Conceptual understanding is good but hands-on is rusty." }, confidence: "medium", rubricWeight: 10, score: 6 },
        { skill: "CI/CD Pipelines", resumeSections: ["Skills", "Experience"], github: { status: "moderate", repos: 4, commits: 80, latest: "1 month ago", detail: "Azure DevOps pipelines and Jenkins shared libraries." }, interview: { status: "confirmed", note: "Designed pipeline architecture but delegates implementation." }, confidence: "medium", rubricWeight: 10, score: 7 },
        { skill: "Terraform / IaC", resumeSections: ["Skills", "Experience"], github: { status: "moderate", repos: 5, commits: 120, latest: "3 weeks ago", detail: "Terraform modules for Azure infrastructure." }, interview: { status: "confirmed", note: "Good module design sense but hasn't written TF in months." }, confidence: "medium", rubricWeight: 10, score: 7 },
      ],
      shouldHave: [
        { skill: "AWS Services", resumeSections: ["Skills", "Experience"], github: { status: "moderate", repos: 3, commits: 55, latest: "6 weeks ago", detail: "AWS CDK stacks for Lambda and DynamoDB." }, interview: { status: "confirmed", note: "AWS knowledge is solid, prefers Azure but can work with AWS." }, confidence: "medium", rubricWeight: 10, score: 7 },
        { skill: "Monitoring / Observability", resumeSections: ["Skills"], github: { status: "weak", repos: 1, commits: 15, latest: "3 months ago", detail: "Basic Azure Monitor configs." }, interview: { status: "gap_confirmed", note: "Relies on team for monitoring setup." }, confidence: "low", rubricWeight: 10, score: 4 },
      ],
      niceToHave: [
        { skill: "Python / Scripting", resumeSections: ["Skills"], github: { status: "moderate", repos: 4, commits: 60, latest: null, detail: "Python and Bash automation scripts." }, interview: { status: "confirmed", note: "Can write scripts but not his primary strength." }, confidence: "medium", rubricWeight: 10, score: 7 },
        { skill: "Security / Compliance", resumeSections: ["Skills", "Experience"], github: { status: "moderate", repos: 2, commits: 30, latest: null, detail: "Azure AD and RBAC configurations." }, interview: { status: "confirmed", note: "Understands compliance requirements from enterprise background." }, confidence: "medium", rubricWeight: 10, score: 8 },
      ],
    },
    githubDiscoveries: [
      { skill: "Azure DevOps", detail: "Extensive pipeline YAML configs — prefers Azure ecosystem", relevant: true },
    ],
  },
  {
    id: "sc-kavya",
    name: "Kavya Reddy",
    initials: "KR",
    email: "kavya.r.devops@gmail.com",
    ...
    growthPotential: 83,
    interviewStatus: "scheduled",
    interviewDate: "2026-02-11T15:00:00Z",
    interviewScores: null,
    interviewKeyFindings: null,
    interviewRecommendation: null,
    rubricMatch: {
      mustHave: [
        { skill: "Kubernetes", resumeSections: ["Skills", "Experience"], github: { status: "moderate", repos: 5, commits: 150, latest: "1 week ago", detail: "EKS and local minikube setups. Dabbling with K8s operators." }, interview: null, confidence: "medium", rubricWeight: 10, score: 6 },
        { skill: "CI/CD Pipelines", resumeSections: ["Skills", "Experience"], github: { status: "strong", repos: 7, commits: 220, latest: "3 days ago", detail: "GitHub Actions, CircleCI, and Buildkite with matrix builds." }, interview: null, confidence: "high", rubricWeight: 10, score: 9 },
        { skill: "Terraform / IaC", resumeSections: ["Skills"], github: { status: "moderate", repos: 4, commits: 90, latest: "2 weeks ago", detail: "Terraform AWS modules — learning Pulumi on the side." }, interview: null, confidence: "medium", rubricWeight: 10, score: 6 },
      ],
      shouldHave: [
        { skill: "AWS Services", resumeSections: ["Skills", "Experience"], github: { status: "strong", repos: 8, commits: 310, latest: "2 days ago", detail: "Lambda, ECS, RDS, CloudFormation, Step Functions." }, interview: null, confidence: "high", rubricWeight: 10, score: 9 },
        { skill: "Monitoring / Observability", resumeSections: ["Skills"], github: { status: "moderate", repos: 3, commits: 70, latest: "1 month ago", detail: "CloudWatch dashboards and basic Grafana setups." }, interview: null, confidence: "medium", rubricWeight: 10, score: 6 },
      ],
      niceToHave: [
        { skill: "Python / Scripting", resumeSections: ["Skills", "Experience"], github: { status: "strong", repos: 10, commits: 380, latest: "1 week ago", detail: "Python boto3 automation, Lambda functions, CLI tools." }, interview: null, confidence: "high", rubricWeight: 10, score: 9 },
        { skill: "Security / Compliance", resumeSections: [], github: { status: "none", repos: 0, commits: 0, latest: null, detail: "No security-specific code found." }, interview: null, confidence: "low", rubricWeight: 10, score: 0 },
      ],
    },
    githubDiscoveries: [
      { skill: "Pulumi", detail: "3 repos exploring Pulumi as IaC alternative — shows initiative to learn", relevant: true },
      { skill: "Serverless Framework", detail: "Lambda-heavy architecture with serverless.yml configs", relevant: true },
    ],
  },
  {
    id: "sc-deepak",
    name: "Deepak Sharma",
    initials: "DS",
    email: "deepak.s.infra@gmail.com",
    ...
    growthPotential: 72,
    interviewStatus: "scheduled",
    interviewDate: "2026-02-13T10:30:00Z",
    interviewScores: null,
    interviewKeyFindings: null,
    interviewRecommendation: null,
    rubricMatch: {
      mustHave: [
        { skill: "Kubernetes", resumeSections: ["Skills"], github: { status: "weak", repos: 2, commits: 30, latest: "1 month ago", detail: "Basic pod and deployment manifests. No Helm or Kustomize." }, interview: null, confidence: "low", rubricWeight: 10, score: 4 },
        { skill: "CI/CD Pipelines", resumeSections: ["Skills", "Experience"], github: { status: "moderate", repos: 4, commits: 100, latest: "2 weeks ago", detail: "Jenkins pipelines with Groovy scripting, basic GitHub Actions." }, interview: null, confidence: "medium", rubricWeight: 10, score: 7 },
        { skill: "Terraform / IaC", resumeSections: ["Skills", "Experience"], github: { status: "moderate", repos: 5, commits: 140, latest: "1 week ago", detail: "Terraform for AWS VPC, EC2, RDS provisioning." }, interview: null, confidence: "medium", rubricWeight: 10, score: 7 },
      ],
      shouldHave: [
        { skill: "AWS Services", resumeSections: ["Skills", "Experience"], github: { status: "strong", repos: 6, commits: 200, latest: "4 days ago", detail: "EC2, VPC, RDS, S3, IAM — traditional infra setup." }, interview: null, confidence: "high", rubricWeight: 10, score: 8 },
        { skill: "Monitoring / Observability", resumeSections: ["Skills"], github: { status: "weak", repos: 1, commits: 20, latest: "2 months ago", detail: "Basic Nagios configs — transitioning to modern stack." }, interview: null, confidence: "low", rubricWeight: 10, score: 4 },
      ],
      niceToHave: [
        { skill: "Python / Scripting", resumeSections: ["Skills"], github: { status: "moderate", repos: 6, commits: 150, latest: "1 week ago", detail: "Bash and Python scripts for server automation." }, interview: null, confidence: "medium", rubricWeight: 10, score: 7 },
        { skill: "Security / Compliance", resumeSections: ["Skills"], github: { status: "weak", repos: 1, commits: 10, latest: null, detail: "Basic IAM policy templates." }, interview: null, confidence: "low", rubricWeight: 10, score: 4 },
      ],
    },
    githubDiscoveries: [
      { skill: "Docker Compose", detail: "12 repos with Docker Compose — solid containerization fundamentals", relevant: true },
    ],
  },
];
