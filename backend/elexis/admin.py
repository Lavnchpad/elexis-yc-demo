...
from .models import Recruiter, Candidate, Job, Organization,JobMatchingResume, Interview, Snapshots, JobRequirement, JobRequirementEvaluation, MaintaineceWindow, JobQuestions , InterviewQuestions
...
admin.site.register(JobMatchingResume, ShowAllFieldsAdmin)